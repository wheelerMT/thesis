...
file = '../../../../../../../thesis_code/data/spin-2/BN_DQV.hdf5';
psiP2 = squeeze(h5read(file, '/initial_state/psiP2').r ...
    + 1j * h5read(file, '/initial_state/psiP2').i);
psiP1 = squeeze(h5read(file, '/initial_state/psiP1').r ...
    + 1j * h5read(file, '/initial_state/psiP1').i);
psi0 = squeeze(h5read(file, '/initial_state/psi0').r ...
    + 1j * h5read(file, '/initial_state/psi0').i);
psiM1 = squeeze(h5read(file, '/initial_state/psiM1').r ...
    + 1j * h5read(file, '/initial_state/psiM1').i);
psiM2 = squeeze(h5read(file, '/initial_state/psiM2').r ...
    + 1j * h5read(file, '/initial_state/psiM2').i);
