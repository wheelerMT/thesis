...
file = '../../../../../../../thesis_code/data/spin-2/5f_C-FM=2_coreless_MH.hdf5';
frame = 2;
...
for i = lower_x_lim:2:upper_x_lim
    for j = lower_y_lim:2:upper_y_lim
...
% exportgraphics(gca, '../../../gfx/ch-spin2/C-FM=2_coreless_FM_init_spherical.pdf')