...
This key result provides a foundation in testing the KZM in subsequent sections,
and has already been successfully applied to numerous spinor BEC
...
integrator~\cite{Symes2016} (see Appendix~\ref{sec: symplectic-integrators} for
details on the numerical integration scheme).
