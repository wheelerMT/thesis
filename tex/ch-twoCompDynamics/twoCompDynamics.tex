...
\subsection{Hydrodynamic properties of a pseudospinor condensate}
...
\begin{figure}
    ...
    \caption{\label{fig: correlation-functions}Correlation functions for the
...
analogous to our two-component system (see Sec.~\ref{subsec: two-comp-numerical-setup}).
