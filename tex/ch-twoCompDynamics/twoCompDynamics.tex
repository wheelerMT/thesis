\chapter{Relaxation dynamics of half-quantum vortices}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
          ...
          \addplot[blue,mark=circle,samples=100, domain=-1.0:1.0] {-x^2 + 5};
          \addplot[red,mark=circle,samples=100, domain=-1.0:1.0] {-4*x^2 + 4};
          \end{axis}
    \end{tikzpicture}
\end{figure}
Results of the dipole motion are plotted in
% Fig.~\ref{fig: two-comp-dipole-motion}.
