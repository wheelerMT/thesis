...
\begin{equation}
    \begin{aligned}
        ...
        + V|\psi_1|^2 + \frac{g_1}{2}|\psi_1|^2 \right] d^3\vb{r}\\
        &+ \int \left[\frac{\hbar^2}{2m_2}|\nabla\psi_2|^2
        + V|\psi_2|^2 + \frac{g_2}{2}|\psi_2|^2 \right] d^3\vb{r}\\
...
We start by assuming, for simplicity, a homogenous system with
\(V(\vb{r}, t)=0\) but with hard barriers at the edge of the system.
