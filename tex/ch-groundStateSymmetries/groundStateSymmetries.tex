...
\begin{figure}
    \begin{tikzpicture}
        ...
        \node at (3.8, 0) {\includegraphics[width=0.3\textwidth]
            {gfx/ch-groundStateSymmetries/polar-spherical.pdf}};
        \node at (7.6, 0) {\includegraphics[width=0.3\textwidth]
            {gfx/ch-groundStateSymmetries/AFM-spherical.pdf}};
        \node at (11.4, 0) {\includegraphics[width=0.3\textwidth]
...
\subsection{Single-valuedness condition}
...
known as half-quantum vortices (HQVs)~\cite{Kawaguchi2012}.
...
\begin{table}
    ...
    details).}
\end{table}
Here, we analytically construct some illustrative examples of vortices arising
in the spin-2 ground state phases.
...
We see from Table~\ref{tab: spin-2-homotopy-groups} that the first homotopy
group of the BN phase is \(\pi_1(\mathcal{M}_\text{BN}) = \mathbb{Z} \cross_h
{(\text{D}^\ast_4)}_{\hat{\vb{F}}}\), which is a non-Abelian
group~\cite{Mermin1979,Kobayashi2012} in which elements of that group do not
commute.
...
Such vortices also arise in the cyclic phase, and numerous studies have
investigated the dynamics of such non-Abelian vortices~\cite{Mawson2015,
Borgh2016}.
