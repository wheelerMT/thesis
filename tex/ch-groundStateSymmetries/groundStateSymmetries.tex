...
In addition to the three-component cyclic state, there is another two-component
state that is useful for understanding the general cyclic state:
\begin{equation}
...
\subsection{Spherical harmonic representation}
The mapping of the order parameter in the spin-2 case follows the same equation
as in the spin-1 case, i.e., Eq.~\eqref{eq: spherical-harmonics}.
...
\begin{figure}
    ...
    respectively. Arrows indicate the direction of magnetisation.
    (c) and (d): the nematic ground states.
    (e) and (f): the cyclic states. Arrows indicate an axis of three-fold
    \((C_3)\) symmetry.}
\end{figure}
