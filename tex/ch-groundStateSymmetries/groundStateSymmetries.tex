...
Both the spherical harmonic and Majorana representations of the EPP and EPP
...
The order parameter space is therefore given as \(\mathcal{M} =
...
condensate density \(n\) yields the general FM-2 wave function which describes
