...
Then, by taking a surface plot of \(|Z(\hat{s})|^2\), the symmetry of the order
parameter can be visualised, where the surface colour is represented by the
argument of \(Z(\hat{s})\).
...
\begin{figure}
    ...
    (a): Spherical harmonic representation, \(|Z(\hat{\vb{s}})|^2\), using
    Eq.~\eqref{eq: spherical-harmonics}, where the black dashed arrow
