...
ferromagnetic state.
A representative spinor, i.e., a spinor that minimises the energy, for a
ferromagnetic ground state is given as~\cite{Kawaguchi2012}
\begin{align}
...
\begin{align}
    \zeta^\mathrm{P} = \frac{e^{i\tau}}{\sqrt{2}}
...
\begin{table}
    ...
    \caption[Ground states arising in spin-1 BECs]{
        \label{tab: spin-1-ground-states}Summary of the ground state
...
\begin{align}
    E_\mathrm{int} = \frac{1}{2}\int c_0n^2 + c_1n^2\spinmag^2+c_2n^2|A_{20}|^2
    \dd^3\vb{r}.
\end{align}
...
duo, \(A_{20}\), is given in Eq.~\eqref{eq: spin-singlet-duo}.
...
minimal spin density and \(|A_{20}|^2 = 1/5\) as in the nematic phase, which
