...
This can be achieved by maintaining a constant \(\chi = \pi \), which can be
achieved by the following family of spinors
...
\end{align}
where now \(\chi = 0\) \textcolor{red}{ask Giuseppe about this.}
The quadratic Zeeman shift can once again be used to interpolate the above
...
\end{gather}
This yields integer spin vortices in the cyclic and both nematic limits.
