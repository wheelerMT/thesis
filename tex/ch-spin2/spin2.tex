...
\begin{equation}\label{eq: FM-BN-energy}
    \mathcal{E}^\mathrm{FM-BN} = \frac{1}{2}\left(c_1-\frac{c_2}{20}\right)f_z^2
...
(Dirac) monopole.
Such a state is realised from the choice \(\tau'=2\alpha=2\varphi \) and choosing
\(\beta = \theta \) where \(\theta \) is the polar angle.
The resulting spinor reads
