\chapter{Relaxation dynamics in a two-component system}\label{ch:relaxation-dynamics-in-a-two-component-system}
...
\section{Half-quantum vortices in spin-1/2}\label{sec:half-quantum-vortices-in-spin-1/2}
